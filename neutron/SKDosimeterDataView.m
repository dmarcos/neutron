...
//        _timeStamp = 0;
        ...
        _sensorTemperatureView = [[UILabel alloc] initWithFrame:CGRectMake(0.0, 200.0, self.bounds.size.width, 120.0)];
        _sensorTemperatureView.textAlignment =  UITextAlignmentCenter;
        _sensorTemperatureView.font = [UIFont fontWithName:@"Helvetica Neue" size:(120.0)];
